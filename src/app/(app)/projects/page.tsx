    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {projects.map((project) => (
          <Card
            key={project.id}
            className="hover:border-[#6366F1]/50 hover:shadow-lg transition-all cursor-pointer group"
          >
            <CardHeader className="flex flex-row items-start justify-between pb-4">
              ...
              <Badge
                ...
                className={cn(
                  ...
                  project.status === 'completed' && 'text-[#10B981] border-[#10B981]/30'
                )}
              >
                {project.status === 'in_progress' ? '进行中' : project.status === 'planning' ? '规划中' : '已完成'}
              </Badge>
            </CardHeader>
