...
const logger = {
  debug: (message, meta) => { if (currentLevel <= LOG_LEVELS.DEBUG) console.debug(formatMessage('DEBUG', message, meta)); },
  info: (message, meta) => { if (currentLevel <= LOG_LEVELS.INFO) console.info(formatMessage('INFO', message, meta)); },
